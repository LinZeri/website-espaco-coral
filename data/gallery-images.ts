 ...
 *
 * IMPORTANTE: cada entrada é de conteúdo ÚNICO. O banco de imagens tem o mesmo
 * arquivo republicado em pastas diferentes (nomes não são confiáveis), então
 * antes de adicionar fotos aqui, conferir o md5 do arquivo para não repetir
 * uma imagem já listada com outro nome.
 */
...
export const GALLERY_IMAGES: GalleryImage[] = [
  ...
  { src: "/images/scenes/casamentos/espaco-coral-casamento-noiva-vestido-floral-01.webp", alt: "Noiva em vestido tomara que caia com aplicação de flores no Espaço Coral", category: "casamentos" },
  ...
  { src: "/images/scenes/salao/espaco-coral-salao-cerejeiras-panoramico-13.webp", alt: "Salão do Espaço Coral com cerejeiras e mesas postas em vista panorâmica", category: "espacos" },
  ...
  { src: "/images/scenes/atracoes/banda/espaco-coral-atracoes-banda-05.webp", alt: "Banda tocando ao vivo durante a Noite Espaço Coral", category: "detalhes" },
  ...
  { src: "/images/scenes/casamentos/espaco-coral-casamento-noiva-pb-01.webp", alt: "Retrato em preto e branco da noiva junto às portas de vidro do Espaço Coral", category: "casamentos" },
  ...
  { src: "/images/scenes/casamentos/espaco-coral-casamento-noiva-neon-costas-03.webp", alt: "Noiva diante de painel neon All You Need Is Love no Espaço Coral", category: "casamentos" },
  ...
  { src: "/images/scenes/decoracao/mesa-de-bolo-e-doces/espaco-coral-decoracao-mesa-de-bolo-e-doces-36.webp", alt: "Mesa de bolo com cerejeiras, rosas brancas e chafariz no Espaço Coral", category: "detalhes" },
  ...
  { src: "/images/scenes/casamentos/espaco-coral-casamento-noiva-veu-jardim-01.webp", alt: "Noiva com véu ao ar livre no jardim do Espaço Coral", category: "casamentos" },
  ...
  { src: "/images/scenes/decoracao-instagramavel/espaco-coral-decoracao-leao-flores-17.webp", alt: "Escultura de leão decorada com flores no Espaço Coral", category: "detalhes" },
  ...
  { src: "/images/scenes/casamentos/espaco-coral-casamento-noiva-varanda-01.webp", alt: "Noiva em vestido de baile na varanda do Espaço Coral", category: "casamentos" },
  ...
  { src: "/images/scenes/ambientes/area-verde/espaco-coral-ambientes-area-verde-01.webp", alt: "Área verde arborizada ao redor do Espaço Coral", category: "espacos" },
  ...
  { src: "/images/scenes/casamentos/espaco-coral-casamento-noiva-vestido-brilho-01.webp", alt: "Noiva em vestido de baile bordado diante das portas de vidro do Espaço Coral", category: "casamentos" },
  ...
  { src: "/images/scenes/casamentos/espaco-coral-casamento-noiva-escada-veu-01.webp", alt: "Noiva com véu e buquê na escada do Espaço Coral", category: "casamentos" },
