...
import type { ProposalData } from "@/lib/proposta/data";
 ...
 *
 * Renderiza hero + introdução + blocos de itens + condições comerciais
 * (quando houver) + CTA de WhatsApp. Sem schema e sem SEO: estas páginas
 * são noindex (definido em app/proposta/layout.tsx) e ficam fora do sitemap.
 */
        ...
        <section className="bg-background px-6 pb-20 md:px-12 md:pb-28 lg:px-20 lg:pb-32">
          <div className="mx-auto max-w-3xl space-y-12">
            {data.blocks.map((block) => (
              <div key={block.eyebrow} className="border-t border-border pt-10">
